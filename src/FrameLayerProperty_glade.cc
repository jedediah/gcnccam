...
{  FrameLayerProperty = this;
   WidgetqVgyCHQ = Gtk::manage(new class Gtk::Label(_("Layer Name: ")));
   ...
   WidgetqVgyCHQ->set_size_request(100,-1);
   WidgetqVgyCHQ->set_alignment(0.5,0.5);
   WidgetqVgyCHQ->set_padding(0,0);
   WidgetqVgyCHQ->set_justify(Gtk::JUSTIFY_LEFT);
   WidgetqVgyCHQ->set_line_wrap(true);
   WidgetqVgyCHQ->set_use_markup(false);
   WidgetqVgyCHQ->set_selectable(false);
   ...
   hbox5->pack_start(*WidgetqVgyCHQ, Gtk::PACK_SHRINK, 0);
